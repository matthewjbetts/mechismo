use utf8;
package Fist::Schema::Result::FragGroup;
...
=head1 TABLE: C<FragGroup>

=cut

__PACKAGE__->table("FragGroup");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AcWhXFaWmoQ44U6GZFBsdA
